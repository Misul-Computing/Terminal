...
export interface ExtensionUIContext {
	 ...
	 * extend `CustomEditor` from `@misul/terminal` and call
	 * `super.handleInput(data)` for keys you don't handle.
	 *
	 * @example
	 * ```ts
	 * import { CustomEditor } from "@misul/terminal";
	 *
...
export interface ExtensionContext {
	...
	/** Gracefully shutdown Misul and exit. Available in all contexts. */
	shutdown(): void;
...
export interface BeforeAgentStartEvent {
	...
	systemPrompt: string;
	/** Structured options used to build the system prompt. Extensions can inspect this to understand what Misul loaded without re-discovering resources. */
...
/** Configuration for registering a provider via misul.registerProvider(). */
...
/**
 * Action implementations for misul.* API methods.
