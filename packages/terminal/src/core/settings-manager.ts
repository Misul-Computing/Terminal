import type { Transport } from "@misul/ai";
import { randomUUID } from "crypto";
import { existsSync, mkdirSync, readFileSync, writeFileSync } from "fs";
import { dirname, join } from "path";
import lockfile from "proper-lockfile";
import { CONFIG_DIR_NAME, getAgentDir, getEnv } from "../config.ts";
...
export interface Settings {
	...
	defaultModel?: string;
	defaultThinkingLevel?: "off" | "auto" | "minimal" | "low" | "medium" | "high" | "xhigh" | "max";
	...
	httpProxy?: string; // Proxy URL applied as HTTP_PROXY and HTTPS_PROXY for Misul-managed HTTP clients
...
export class SettingsManager {
	...
	getDefaultThinkingLevel(): "off" | "auto" | "minimal" | "low" | "medium" | "high" | "xhigh" | "max" | undefined {
		return this.settings.defaultThinkingLevel;
	}

	setDefaultThinkingLevel(level: "off" | "auto" | "minimal" | "low" | "medium" | "high" | "xhigh" | "max"): void {
	...
	getClearOnShrink(): boolean {
		...
		return getEnv("CLEAR_ON_SHRINK") === "1";
	}
	...
	getShowHardwareCursor(): boolean {
		return this.settings.showHardwareCursor ?? getEnv("HARDWARE_CURSOR") === "1";
	}
