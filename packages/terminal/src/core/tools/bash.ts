...
import { Container, Text, truncateToWidth } from "@misul/tui";
...
/**
 * Create bash operations using Misul's built-in local shell execution backend.
 *
 * This is useful for extensions that intercept user_bash and still want Misul's
...
export function createBashToolDefinition(
	...
	return {
		...
		async execute(
			...
			const output = new OutputAccumulator({ tempFilePrefix: "misul-bash" });
