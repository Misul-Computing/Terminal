...
import type { AgentMessage, StreamFn, ThinkingLevel } from "@misul/agent-core";
import type { AssistantMessage, Context, Model, SimpleStreamOptions, Usage } from "@misul/ai";
...
function extractFileOperations(
	...
	// Collect from previous compaction's details (if Misul-generated)
