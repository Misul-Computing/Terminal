...
const VALID_THINKING_LEVELS = ["off", "auto", "minimal", "low", "medium", "high", "xhigh", "max"] as const;
	...
	const extensionFlagsText =
		extensionFlags && extensionFlags.length > 0
			? `\n${chalk.bold("Extension CLI Flags:")}\n${extensionFlags
					...
					.join("\n")}\n`
			: "";
	console.log(`${chalk.bold("Misul Terminal")} - AI coding assistant with read, bash, edit, write tools
...
${chalk.bold("Options:")}
  ...
  --exclude-tools, -xt <tools>   Comma-separated denylist of tool names to disable
                                 Applies to built-in, extension, and custom tools
  --agent <name>                 Apply an optional agent persona (simple or deep-work)
                                 Default: none; the main agent uses its own constitution
  ...
  --extension, -e <path>         Load an extension file or directory
