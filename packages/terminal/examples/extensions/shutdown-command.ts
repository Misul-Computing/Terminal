 ...
 * Demonstrates how extensions can use ctx.shutdown() to exit misul cleanly.
 */
...
export default function (api: ExtensionAPI) {
	// Register a /quit command that cleanly exits misul
	api.registerCommand("quit", {
		description: "Exit misul cleanly",
	...
	api.registerTool({
		...
		description: "Complete a task and exit misul",
	...
	api.registerTool({
		...
		description: "Deploy the application and exit misul",
		parameters: Type.Object({
