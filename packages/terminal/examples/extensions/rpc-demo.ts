...
export default function (api: ExtensionAPI) {
	...
	api.on("session_start", async (event, ctx) => {
		ctx.ui.setTitle(event.reason === "new" ? "misul RPC Demo (new session)" : "misul RPC Demo");
	...
	api.registerCommand("rpc-editor", {
	...
	api.registerCommand("rpc-prefill", {
