 ...
 *
 *   mkdir -p ~/.misul/agent/extensions
 *   cp packages/coding-agent/examples/extensions/project-trust.ts ~/.misul/agent/extensions/
 *
 * Or:
 *
 *   misul -e packages/coding-agent/examples/extensions/project-trust.ts
 *
 * Try it in a project containing .misul, AGENTS.md/CLAUDE.md, or .agents/skills.
 */

import type { ExtensionAPI, ProjectTrustEventResult } from "@misul/terminal";
...
export default function (api: ExtensionAPI) {
	...
	api.on("project_trust", async (event, ctx): Promise<ProjectTrustEventResult> => {
