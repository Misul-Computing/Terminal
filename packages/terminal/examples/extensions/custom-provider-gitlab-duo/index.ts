 ...
 * Delegates to misul-ai's built-in Anthropic and OpenAI streaming implementations.
 *
 * Usage:
 *   misul -e ./packages/coding-agent/examples/extensions/custom-provider-gitlab-duo
