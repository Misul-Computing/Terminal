 ...
 * working indicator shown while misul is streaming a response.
 *
 * Usage:
 *   misul --extension examples/extensions/working-indicator.ts
 *
 * Commands:
 ...
 *   /working-indicator reset     Restore misul's default spinner
 */

import type { ExtensionAPI, ExtensionContext, WorkingIndicatorOptions } from "@misul/terminal";
...
export default function (api: ExtensionAPI) {
	...
	api.registerCommand("working-indicator", {
