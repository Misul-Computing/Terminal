 ...
 * (logo + keybinding hints) with a custom component showing the misul mascot.
 */

import type { ExtensionAPI, Theme } from "@misul/terminal";
import { VERSION } from "@misul/terminal";

// --- PI MASCOT ---
// Based on pi_mascot.ts - the misul agent character
...
export default function (api: ExtensionAPI) {
	...
	api.registerCommand("builtin-header", {
