...
import { Agent } from "@misul/agent-core";
import { getModel, type OAuthCredentials, type OAuthProvider } from "@misul/ai";
...
// ============================================================================
// OAuth API key resolution from ~/.misul/agent/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".misul", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.misul/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.misul/agent/auth.json
 */
