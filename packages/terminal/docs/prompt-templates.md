> misul can create prompt templates. Ask it to build one for your workflow.
...
Misul Terminal loads prompt templates from:

- Global: `~/.misul/agent/prompts/*.md`
- Project: `.misul/prompts/*.md` (only after the project is trusted)
- Packages: `prompts/` directories or `misul.prompts` entries in `package.json`
