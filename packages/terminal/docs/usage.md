...
|----------|-------------|
| `MISUL_CODING_AGENT_DIR` | Override config directory; default is `~/.pi/agent` |
| `MISUL_CODING_AGENT_SESSION_DIR` | Override session storage directory; overridden by `--session-dir` |
