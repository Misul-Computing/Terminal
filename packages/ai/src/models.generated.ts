...
export const MODELS = {
	...
	"cline-pass": {
		"deepseek-v4-flash": {
			...
			compat: {"thinkingFormat":"deepseek","supportsReasoningEffort":false,"maxTokensField":"max_tokens","requiresReasoningContentOnAssistantMessages":true},
			reasoning: true,
			thinkingLevelMap: {"off":"off","minimal":null,"low":null,"medium":null,"high":"high","xhigh":null,"max":"max"},
			input: ["text"],
			cost: {
	...
	"github-copilot": {
		...
		"claude-opus-4.7": {
			...
			compat: {"forceAdaptiveThinking":true,"supportsTemperature":false},
			reasoning: true,
			thinkingLevelMap: {"off":null,"minimal":"low","low":"low","medium":"medium","high":"high","xhigh":"xhigh","max":null},
			input: ["text", "image"],
			cost: {
				input: 5,
				output: 25,
		...
		"claude-sonnet-4.6": {
			...
			compat: {"forceAdaptiveThinking":true},
			reasoning: true,
			thinkingLevelMap: {"off":"off","minimal":"low","low":"low","medium":"medium","high":"high","xhigh":"max","max":null},
			input: ["text", "image"],
			cost: {
				input: 3,
				output: 15,
	...
	"groq": {
		...
		"qwen/qwen3-32b": {
			...
			reasoning: true,
			thinkingLevelMap: {"off":"off","minimal":null,"low":null,"medium":null,"high":"default","xhigh":null,"max":null},
			input: ["text"],
			cost: {
				input: 0.29,
				output: 0.59,
	...
	"opencode": {
		...
		"kimi-k2.5": {
			...
			provider: "opencode",
			baseUrl: "https://opencode.ai/zen/v1",
			compat: {"maxTokensField":"max_tokens","supportsLongCacheRetention":false,"supportsReasoningEffort":false},
			reasoning: true,
			thinkingLevelMap: {"off":"off","minimal":null,"low":null,"medium":null,"high":"high","xhigh":null,"max":null},
			input: ["text", "image"],
			cost: {
	...
	"opencode-go": {
		...
		"qwen3.6-plus": {
			...
			provider: "opencode-go",
			baseUrl: "https://opencode.ai/zen/go/v1",
			compat: {"thinkingFormat":"qwen","maxTokensField":"max_tokens","supportsReasoningEffort":false},
			reasoning: true,
			thinkingLevelMap: {"off":"off","minimal":null,"low":null,"medium":null,"high":"high","xhigh":null,"max":null},
			input: ["text", "image"],
			cost: {
	...
	"openrouter": {
		...
		"moonshotai/kimi-k2.6": {
			...
			provider: "openrouter",
			baseUrl: "https://openrouter.ai/api/v1",
			compat: {"supportsDeveloperRole":false,"requiresReasoningContentOnAssistantMessages":true,"supportsReasoningEffort":false},
			reasoning: true,
			thinkingLevelMap: {"off":"off","minimal":null,"low":null,"medium":null,"high":"high","xhigh":null,"max":null},
			input: ["text", "image"],
			cost: {
	...
	"zai": {
		"glm-4.5-air": {
			...
			compat: {"supportsDeveloperRole":false,"thinkingFormat":"zai","supportsReasoningEffort":false},
			reasoning: true,
			thinkingLevelMap: {"off":"off","minimal":null,"low":null,"medium":null,"high":"high","xhigh":null,"max":null},
			input: ["text"],
			cost: {
		...
		"glm-4.7": {
			...
			provider: "zai",
			baseUrl: "https://api.z.ai/api/coding/paas/v4",
			compat: {"supportsDeveloperRole":false,"thinkingFormat":"zai","zaiToolStream":true,"supportsReasoningEffort":false},
			reasoning: true,
			thinkingLevelMap: {"off":"off","minimal":null,"low":null,"medium":null,"high":"high","xhigh":null,"max":null},
			input: ["text"],
			cost: {
