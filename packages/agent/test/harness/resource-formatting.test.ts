...
describe("resource formatting helpers", () => {
	it("formats skill invocations with additional instructions", () => {
		const skill = {
			...
			filePath: "/project/.misul/skills/inspect/SKILL.md",
		};

		expect(formatSkillInvocation(skill, "Check errors.")).toBe(
			'<skill name="inspect" location="/project/.misul/skills/inspect/SKILL.md">\nReferences are relative to /project/.misul/skills/inspect.\n\nUse inspection tools.\n</skill>\n\nCheck errors.',
		);
	});
